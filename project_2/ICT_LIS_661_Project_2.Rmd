...
## Project 2, Part 2: Descriptive Statistics [6 points]

> In the code chunk below, write code to determine the number of observations in the dataset. As is typical for R, there are a number of ways to do this—*how* you do so is less important than *that* you do so. [1 point]

```{r}

```

> In the code chunk below, write code to list the variables included in the dataset. Then, below the code chunk, list and explain 5-10 of the most important quantitative variables. (The quantitative part will become important in the next step!) [2 points]
...
> In the code chunk below, calculate descriptive statistics (including mean, median, variance, and standard deviation) for each of the variables you listed above. Then, below the code chunk, say what those descriptive statistics tell you about those variables. [1 point]
