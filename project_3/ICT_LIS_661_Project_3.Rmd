...
## Project 3, Part 1: Your Dataset [2 points]
...
> As needed, perform any data cleaning (including "tidying" or subsetting) on the data in the code chunk below. [1 point]
...
## Project 3, Part 2: T-Test [4 points]

> For this part of the project, you will be carrying out a t-test. Please recall that the typical purpose of a t-test is to compare two means or two proportions!

### Hypotheses

> Below, please describe a null hypothesis and an alternative hypothesis related to this data that can be tested using a t-test. [1 point]


### Data Analysis

> In the code chunk below, please carry out a t-test that will test the hypotheses listed above. Then, below the code chunk, summarize the results of this analysis; pay particular attention to statistical significance! [2 points]
...
> Below, interpret the results of this analysis (that is, describe what the results mean for your data). Please also discuss any practical implications of these results (that is, explain how people might wish to think or act differently based on these results). [1 point]



## Project 3, Part 3: Regression [4 points]
...
> Below, please describe a null hypothesis and an alternative hypothesis) related to this data that can be tested using regression. [1 point]


### Data Analysis

> In the code chunk below, please carry out a regression that will test the hypotheses listed above. Then, below the code chunk, summarize the results of this analysis. Make particular reference to relevant statistics, including coefficient and p-value. [2 points]
