...
> In the code chunk below, run all the code necessary to respond to the questions below; please note that this should include at least one visualization! [1 point]
...
> Explain how you imported, cleaned, and manipulated the data for analysis. [1 point]



> Provide the description of key variables and their descriptive statistics. What do these descriptive statistics tell you about the data? [1 point]



> Explain how you visualized the data, why you chose that visualization, and what it tells you about the data. [1 point]
...
> Describe at least four null hypotheses (and four accompanying alternative hypotheses) you wish to test, and explain each hypothesis in detail—in terms of the variables identified above. [4 points]
